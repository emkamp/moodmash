        ...
        $.ajax({
            ...
            for (i = 0; i < eventListings.length; i++) {
                ...
                if (eventListings[i].venue.city === userCity) {
                    ...
                    var artistDiv = $('<div class="event-div well"><div class="btn-close pull-right"><i class="glyphicon glyphicon-remove"></i></div><div class="btn-save pull-right"><i class="glyphicon glyphicon-star"></i></div></div>');
            ...
            $(".btn-close").on('click', function() {
                ...
                $(this).closest(".event-div").slideUp();
            });
